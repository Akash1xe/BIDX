...
const ROUTES = [
  ...
  { prefix: "/api/v1/bids", service: "bidding", target: env.services.bidding, auth: true },
  { prefix: "/api/v1/payments/webhook", service: "payment", target: env.services.payment, auth: false },
  { prefix: "/api/v1/payments", service: "payment", target: env.services.payment, auth: true },
  { prefix: "/api/v1/notifications", service: "notification", target: env.services.notification, auth: true },
  { prefix: "/api/v1/admin", service: "admin", target: env.services.admin, auth: true }
