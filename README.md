...
The production-ready Next.js application lives in [`frontend/`](frontend).
It includes buyer, seller, payment, notification, and admin flows connected
through the API Gateway, plus production tests and deployment documentation.

- [Frontend setup](frontend/README.md)
- [Production guide](frontend/docs/PRODUCTION.md)
- [Release checklist](frontend/docs/RELEASE_CHECKLIST.md)
- [Live checkpoint](https://bidx-frontend.codingchess06.chatgpt.site)
